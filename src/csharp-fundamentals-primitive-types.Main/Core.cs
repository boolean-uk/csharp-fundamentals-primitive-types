...
namespace csharp_fundamentals_primitive_types.Main
{
    public class CoreExercise
    {
        ...
        public int sum = numOne + numThree + numTwo;
        ...
        // 7. Create a public static char member named lastLetter containing the CAPITALISED last letter of the English alphabet
        ...
        public char tenthLetter = alphabet.ToCharArray().ElementAtOrDefault(10-1);        
