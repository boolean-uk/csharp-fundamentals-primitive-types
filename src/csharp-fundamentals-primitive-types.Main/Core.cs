...
namespace csharp_fundamentals_primitive_types.Main
{
    public class Core
    {
        ...
        public int numThreeTimesNumTwo = numTwo * numThree;
        ...
        public char lastLetter = alphabet.ToCharArray().Last();
        ...
        public char tenthLetter = alphabet.ToCharArray().ElementAtOrDefault(9); //starts at zero
        ...
        public int remainder = 15 % 8; //used modulo operator
    }
