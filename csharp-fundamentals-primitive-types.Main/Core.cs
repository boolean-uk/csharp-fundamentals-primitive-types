namespace csharp_fundamentals_primitive_types.Main
{
    ...
    public class Car
    {
        ...
        public string model = "940";
        public string transmissionType = "5 speed";
        public int nrOfDoors = 5;
        public float nrOfCars = 2.4f;
        public int nrOfCylinders = 4;
        public string colour = "red";
        public string registration = "ABC 123";
    }
    ...
    public class Movie
    {
        public string series = "Lord of the Rings";
        public string title = "Fellowship of the Ring";
        public int releaseYear = 2001;
        public string director = "Peter Jackson";
    }
    ...
    public class SocialmediaPost
    {
        ...
        public string desc = "Lorem ipsum";
    ...
    public class ECommerceOrder
    {
        ...
        public string customerName = "Jon";
        public int orderPrice = 123;
