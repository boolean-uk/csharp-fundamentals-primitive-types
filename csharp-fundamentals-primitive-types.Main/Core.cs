...
namespace csharp_fundamentals_primitive_types.Main
{
    public class Core
    {
        ...
        public char lastLetter = alphabet.ToCharArray().ElementAtOrDefault(alphabet.Length-1);
        ...
        public double piD = 3.14159d; //Note: MathF.Round(MathF.PI,5);  Should work but doesn't pass the test.
